...
# kubealex.com/k8s-mediaserver-operator-bundle:$VERSION and kubealex.com/k8s-mediaserver-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubealex.com/k8s-mediaserver-operator
